...
params:
  image: /docs/domain-driven-design/images/strategic-design.png
---
...
- [Domain Storytelling](/docs/domain-driven-design/domain-storytelling/) - get knowledge from domain experts and stakeholders through storytelling
- [EventStorming](/docs/domain-driven-design/eventstorming/) - collaboratively model the domain by focusing on events and their consequences
- [Context Mapping](/docs/domain-driven-design/context-mapping/) - visualize the relationships and dependencies between different bounded contexts
