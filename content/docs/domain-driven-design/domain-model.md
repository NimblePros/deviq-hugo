...
params:
  image: /docs/domain-driven-design/images/domain-model.png
---
...
The evolution of a domain model happens in 2 phases: [strategic design](/docs/domain-driven-design/strategic-design/) and [tactical design](/docs/domain-driven-design/tactical-design/).
...
Bounded contexts may be discovered through [EventStorming](/docs/domain-driven-design/eventstorming/). These contexts may include:
- Catalog management
- Member management
