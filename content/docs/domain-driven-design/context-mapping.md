...
params:
  image: /docs/domain-driven-design/images/context-mapping.png
---
...
The [anti-corruption layer](./anti-corruption-layer) serves as a translation layer between upstream and downstream teams. This layer is commonly built with [Facades](/docs/design-patterns/facade-pattern/) and [Adapters](/docs/design-patterns/adapter-design-pattern/).
