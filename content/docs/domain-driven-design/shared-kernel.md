...
params:
  image: /docs/domain-driven-design/images/shared-kernel.png
---
...
- [Ubiquitous Language](/docs/domain-driven-design/ubiquitous-language/): This includes common terms, concepts, and vocabulary used to describe the domain across all bounded contexts.
- [Domain Models](/docs/domain-driven-design/domain-model/): This encompasses core entities, value objects, and other domain objects representing essential domain concepts.
...
- [Anti-Corruption Layer](/docs/domain-driven-design/anti-corruption-layer/): Each context can adapt the shared kernel's data and logic to its specific needs.
