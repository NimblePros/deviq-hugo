...
params:
  image: /docs/domain-driven-design/images/anti-corruption-layer.png
---
...
This layer is typically made up of several well-known design patterns such as [Facade](/docs/design-patterns/design-patterns-overview/) and [Adapter](/docs/design-patterns/adapter-design-pattern/). The patterns are used to map between foreign domain models and APIs to types and interfaces that are part of the domain model.
