...
params:
  image: /docs/domain-driven-design/images/eventstorming.png
---
...
- Facilitates [communication](/docs/values/communication/) between teams
  - By building up better communication channels between teams, this could lead to better morale when these teams collaborate in the future. Software development works better as a [whole team activity](/docs/practices/whole-team-activity/).
