...
The checks for null and common behavior of throwing a particular type of exception is clearly a violation of the [DRY principle](/docs/principles/dont-repeat-yourself/). This code can be pulled out into a helper method:
