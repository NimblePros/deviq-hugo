...
params:
  image: /docs/design-patterns/images/decorator-design-pattern.png
---
...
This pattern is an excellent way to follow the [Single Responsibility Principle](/docs/principles/single-responsibility-principle/), since cross-cutting concerns like Logging, Validation, Authorization checks, and more can be pulled out of a class and moved into a single-purpose decorator class. This also helps achieve the [Open-Closed Principle](/docs/principles/open-closed-principle/), since new functionality can be added to existing classes (without modifying them) through the use of decorators.
