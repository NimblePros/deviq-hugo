...
params:
  image: /docs/design-patterns/images/object-mother-pattern.png
---
...
The downfall to the Object Mother pattern is that the class can become bloated over time with repetitive code. [DRY](/docs/principles/dont-repeat-yourself/) is important to keep in mind, as there may be parts of object creation that are repeated between different types of objects with the same mother.

An alternative to the Object Mother pattern is the [Builder pattern](/docs/design-patterns/builder-pattern/).
...
- [Builder Pattern](/docs/design-patterns/builder-pattern/)
- [Factory Method Pattern](/docs/design-patterns/factory-method-pattern/)
