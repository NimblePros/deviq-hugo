...
params:
  image: /docs/design-patterns/images/facade-pattern.png
---

The Facade Pattern is used when you want a simpler interface for a subsystem of a complex system. The complex system typically contains a code smell known as [the big ball of mud](/docs/antipatterns/big-ball-of-mud/) that typically evolves from [the blob](/docs/antipatterns/blob/). By using a facade, you create an interface that only shows the necessary endpoints for a subset of a system rather than the entire complex system.
...
Those are many subsystems. Some of those may be related, but having them all in one API violates the [KISS](/docs/principles/keep-it-simple/) and [separation of concerns](/docs/principles/separation-of-concerns/) principles. Facades embrace [simplicity](/docs/values/simplicity/).
...
- [Strangler Fig Pattern](/docs/design-patterns/strangler-fig-pattern/)
