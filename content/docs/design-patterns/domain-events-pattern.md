...
params:
  image: /docs/design-patterns/images/domain-events-pattern.png
---
...
The [Mediator pattern](/docs/design-patterns/mediator-pattern/) is commonly used when working with domain events. Let's go through some code examples to understand how to implement Domain Events using [MediatR](https://github.com/jbogard/MediatR) in a C#/.NET application.
