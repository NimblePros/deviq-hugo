...
params:
  image: /docs/design-patterns/images/factory-method-pattern.png
---
...
You can use [dependency injection](/docs/practices/dependency-injection/) to use the factory interfaces where needed and then pass along specific implementations of the factories when needed.
