...
- Inappropriate Static / [Static Cling](/docs/antipatterns/static-cling/)
...
- Not Enough Tests
- [DRY](/docs/principles/dont-repeat-yourself/) versus DAMP
- Fragility
- The Liar
- Excessive Setup
- The Giant
