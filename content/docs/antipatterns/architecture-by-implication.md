...
1. **Inconsistent design decisions**: Without a [clear architectural vision](/docs/practices/common-architectural-vision/), developers may make design decisions that are inconsistent with each other, leading to a disjointed system.
