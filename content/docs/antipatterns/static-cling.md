...
To refactor away from Static Cling, replace the static method call with an instance method call on an instance type (frequently implementing an interface), and use the [strategy design pattern](/docs/design-patterns/strategy-pattern/) (also known as [dependency injection](/docs/practices/dependency-injection/)) to inject the dependency into the class that needs the functionality. In the case where the static functionality is not code you control, you can access it through an [Adapter](/docs/design-patterns/adapter-design-pattern/). This approach is shown below:
...
[Dependency Injection](/docs/practices/dependency-injection/)

[Strategy Design Pattern](/docs/design-patterns/strategy-pattern/)

[Adapter Design Pattern](/docs/design-patterns/adapter-design-pattern/)
