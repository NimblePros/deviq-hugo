...
params:
  image: /docs/antipatterns/images/feature-creep-400x400.jpg
---
...
When the project's scope begins expanding to the point where it will delay shipping the project on time (or at all), remember that [Shipping is a Feature](/docs/practices/shipping-is-a-feature/), and your product must have it.
