...
Antipatterns are simply [design patterns](/docs/design-patterns/design-patterns-overview/) that in many cases introduce more problems than they solve. Sometimes these are coding patterns, while others describe problems within teams or organizations.
...
- [Singleton](/docs/design-patterns/singleton/)
