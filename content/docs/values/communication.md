...
Even on a team of one, communication with your future self can be a challenge. Writing code that is [simple](/docs/principles/keep-it-simple/) and [readable](/docs/practices/code-readability/) helps you when you are maintaining code you wrote some time ago, ensuring you understand what it's doing and how best to adjust it to meet new needs.

## See Also

[Courage](/docs/values/courage/)

[Feedback](/docs/values/feedback/)

[Respect](/docs/values/respect/)

[Simplicity](/docs/values/simplicity/)
