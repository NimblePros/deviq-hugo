...
params:
  image: /docs/architecture/images/vertical-slice-architecture.png
---
...
- [Code smells](/docs/antipatterns/code-smells/) - know what antipatterns to avoid and watch out for in business logic
- [Refactoring](/docs/practices/refactoring/) - know how to refactor and get away from the code smells
