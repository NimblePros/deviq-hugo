...
params:
  image: /docs/architecture/images/clean-architecture.png
---
...
The key to these architectural approaches is [separation of concerns](/docs/principles/separation-of-concerns/). There are layers for use cases, business rules, and other key concepts. Each of those layers - except the business rules - has a dependency on an inner layer.
