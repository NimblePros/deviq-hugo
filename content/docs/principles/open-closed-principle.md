...
params:
  image: /docs/principles/images/open-closed-principle-400x400.jpg
---
...
The Open-Closed Principle can also be achieved in many other ways, including through the use of inheritance or through compositional design patterns like the [Strategy pattern](/docs/design-patterns/strategy-pattern/).
