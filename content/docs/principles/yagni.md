...
params:
  image: /docs/principles/images/yagni-400x400.png
---
...
- [Keep It Simple, Stupid (KISS)](/docs/principles/keep-it-simple/)
- [Repository Pattern](/docs/design-patterns/repository-pattern/)
- [Pain Driven Development](/docs/practices/pain-driven-development/)
- [Red, Green, Refactor](/docs/practices/red-green-refactor/)
