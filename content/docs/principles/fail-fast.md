...
params:
  image: /docs/principles/images/fail-fast.png
---
...
Practices like [defensive programming](/docs/practices/defensive-programming/) and patterns like [guard clauses](/docs/design-patterns/guard-clause/) are frequently applied in order to follow the fail fast principle.
