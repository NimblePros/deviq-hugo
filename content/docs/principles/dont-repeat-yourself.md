...
The [Open/Closed Principle](/docs/principles/open-closed-principle/) only works when DRY is followed.

The [Single Responsibility Principle](/docs/principles/single-responsibility-principle/) relies on DRY.
