...
params:
  image: /docs/practices/images/CommonArchitecturalVision-400x400.png
---
...
Microservices aren't the only designs that can more easily be updated. Any application that follows [separation of concerns](/docs/principles/separation-of-concerns/) and other software design principles will be easier to update and maintain than a system that is full of [spaghetti code](/docs/antipatterns/spaghetti-code/).
