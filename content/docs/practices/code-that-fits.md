...
params:
  image: /docs/practices/images/code-that-fits.png
---
...
1. [The 50/72 Rule](/docs/practices/50-72-rule/)
2. The 80/24 Rule
3. [Arrange Act Assert](/docs/testing/arrange-act-assert/)
4. Bisection
...
15. [Parse, Don't Validate](/docs/practices/parse-dont-validate/)
16. [Postel's Law](/docs/laws/postels-law/)
17. [Red, Green, Refactor](/docs/practices/red-green-refactor/)
...
23. [Slice (vertical)](/docs/practices/vertical-slices/)
24. [Strangler (fig)](/docs/design-patterns/strangler-fig-pattern/)
25. Threat Model
