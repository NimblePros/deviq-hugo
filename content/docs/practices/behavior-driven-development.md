...
params:
  image: /docs/practices/images/behavior-driven-development.png
---

Behavior Driven Development (BDD) is a software development practice that focuses on defining the behavior of a software system in a way that's easy to understand for both technical and non-technical stakeholders. It's a [whole team activity](/docs/practices/whole-team-activity/) that encourages collaboration among developers, testers, and business stakeholders by using plain language descriptions of how a system should behave.
...
- [Test-Driven Development](/docs/practices/test-driven-development/)
