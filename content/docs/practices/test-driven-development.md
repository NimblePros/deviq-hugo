...
params:
  image: /docs/practices/images/test-driven-development.png
---
...
The next step is to [refactor](/docs/practices/refactoring/) your code. Since the second step is all about getting to _**GREEN**_ as quickly and simply as possible, sometimes there will be duplication or inelegant code that needs to be fixed up. Look for any [code smells](/docs/antipatterns/code-smells/) or obvious [technical debt](/docs/terms/technical-debt/), especially [duplication](/docs/principles/dont-repeat-yourself/) [duplication](/docs/principles/once-and-only-once/), and clean it up during this stage. Be sure to continue to run your test suite and ensure it remains _**GREEN**_ - refactoring should not change what your code does but only how it does it, and your tests are there to ensure this is the case. Learn about [refactoring for C# Developers](https://www.pluralsight.com/courses/refactoring-csharp-developers) to make sure you're keeping your codebase clean.
...
- [Behavior-Driven Development](/docs/practices/behavior-driven-development/)
