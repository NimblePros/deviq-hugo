...
params:
  image: /docs/practices/images/parse-dont-validate.png
---
...
The beauty of the DateTime type is that developers can be confident that it is always valid. **That's the point of parsing - to produce a higher level more constrained type that doesn't require validation because it cannot be invalid.** Using proper types instead of [the primitive obsession code smell](/docs/antipatterns/code-smells/) will make your methods easier to write correctly.
