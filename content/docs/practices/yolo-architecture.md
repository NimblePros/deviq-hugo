...
params:
  image: /docs/practices/images/yolo-architecture.png
---
...
2. **Modularity**: Structure the codebase into well-defined modules or layers, adhering to principles like [SOLID](/docs/principles/solid/), [Separation of Concerns](/docs/principles/separation-of-concerns/), and delivering software features as [Vertical Slices](/docs/practices/vertical-slices/)
...
1. [The Big Ball of Mud](/docs/antipatterns/big-ball-of-mud/)
2. [SOLID Principles](/docs/principles/solid/)
...
5. [Architecture by Implication](/docs/antipatterns/architecture-by-implication/)
