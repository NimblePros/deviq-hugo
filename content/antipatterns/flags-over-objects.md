...
There are many ways to address this anti-pattern. In the worst cases, the [State design pattern](/design-patterns/state-design-pattern/) can effectively be used to bring all state-transition related behavior into the object, or at least into objects specifically constructed to handle the responsibility of state and state transitions.
