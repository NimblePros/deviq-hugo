...
2. **High coupling and low [cohesion](/terms/cohesion/)**: The system may exhibit high coupling between components and low [cohesion](/terms/cohesion/) within components, making it difficult to maintain and scale.
