...
- [Interpreter](/design-patterns/interpreter-pattern/) - represent composable rule expressions as an abstract syntax tree that can be evaluated against a context
