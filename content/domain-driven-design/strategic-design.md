...
- [Domain Storytelling](/domain-driven-design/domain-storytelling/) - get knowledge from domain experts and stakeholders through storytelling
- [EventStorming](/domain-driven-design/eventstorming/) - collaboratively model the domain by focusing on events and their consequences
- [Context Mapping](/domain-driven-design/context-mapping/) - visualize the relationships and dependencies between different bounded contexts
